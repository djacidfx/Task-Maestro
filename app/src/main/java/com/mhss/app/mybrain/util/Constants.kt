...
object Constants {
    ...
    // lINKS
    const val PROJECT_GITHUB_LINK = "https://github.com/djacidfx/Task-Maestro"
    const val PROJECT_ROADMAP_LINK = "https://github.com/users/mhss1/projects/2/"
    const val PRIVACY_POLICY_LINK = "https://github.com/djacidfx/Task-Maestro/blob/master/privacy-policy.md"
    const val GITHUB_ISSUES_LINK = "https://github.com/djacidfx/Task-Maestro/issues"
    const val GITHUB_RELEASES_LINK = "https://github.com/djacidfx/Task-Maestro/releases"
